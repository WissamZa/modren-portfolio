...
import {Skills} from "../../types/index.ts";
...
const HomePage: React.FC = () => {
    ...
    const skills:Skills = t('home.skills.list', {returnObjects: true}) as Skills;
                            ...
                            {skills.map((skill) => (
                                ...
                                >
                                    <Card glass hoverable className="p-6 text-center">
                                        <div
                                            className="w-12 h-12 bg-linear-to-r from-blue-600 to-purple-600 rounded-lg mx-auto mb-3 flex items-center justify-center">
